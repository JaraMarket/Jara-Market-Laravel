...
class customerSignupRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'vehicle_photo' => 'required|array|min:1|max:5', // Multiple vehicle photos allowed, between 1 and 5
            'vehicle_photo.*' => 'image|mimes:jpeg,png,jpg,gif|max:2048', // Validate each photo in the array
        ];
    }
