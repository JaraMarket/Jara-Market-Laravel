...
public function viewProfile(Request $request)
{
    ...
    return response()->json(['success' => true, 'message' => 'Customer data fetched successfully','data' => $customerData], 200);

    }

//fetch customer data using email
//$customerData = Customer::where('email', $email)->first();
//return response()->json(['success' => true, 'message' => 'Customer data fetched successfully',
