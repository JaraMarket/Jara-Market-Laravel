...
public function Customer_login(customerLoginRequest $request)
{
    ...
    return response()->json(['success' => true, 'message' => 'An OTP has been sent to your email address. Please enter the OTP to complete the login process.', 'data' => $customer->email], 200);
}
